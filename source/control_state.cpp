...
void control_state::Refresh(const input_state& inputState, const input_state& previousInputState)
{
  ...
  f1Press = !(keyboardState[DIK_F1] & 0x80) && previousKeyboardState[DIK_F1] & 0x80;
  f2Press = !(keyboardState[DIK_F2] & 0x80) && previousKeyboardState[DIK_F2] & 0x80;
  f12Press = !(keyboardState[DIK_F12] & 0x80) && previousKeyboardState[DIK_F12] & 0x80;
