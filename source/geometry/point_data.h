...
namespace point_data
{
  ...
  auto BoundaryLinesToOrderedBoundaryPoints(std::ranges::input_range auto&& lineData, int cellWidth, int cellHeight, auto boundaryInserter) -> void;
  ...
  auto CellsIdsToOrderedBoundaryPoints(std::ranges::input_range auto&& cellIds, int cellWidth, int cellHeight, auto boundaryInserter) -> void
  {
    ...
    BoundaryLinesToOrderedBoundaryPoints(lineData, cellWidth, cellHeight, boundaryInserter);
  }
