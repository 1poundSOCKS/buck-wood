...
level_control_data::level_control_data() :
  m_timerControl(std::make_shared<level_timer::control>()), 
  m_stateControl(std::make_shared<level_state::control>())
{
}

level_control_data::level_control_data(const level_timer::control_data timerControl, const level_state::control_data stateControl)
{
