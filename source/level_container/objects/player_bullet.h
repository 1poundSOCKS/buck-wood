...
public:
  ...
  player_bullet(POINT_2F position, VELOCITY_2F velocity, int damage) : base_object { position, { 0.8f, 0.8f }, direct2d::CalculateDirection(velocity) }, object_velocity { velocity },
    m_damage { damage }
  {
  }
