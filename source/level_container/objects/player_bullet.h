...
public:
  ...
  player_bullet(POINT_2F position, VELOCITY_2F velocity, int damage) : base_object { position, { 1.0f, 1.0f }, direct2d::CalculateDirection(velocity) }, object_velocity { velocity },
    m_damage { damage }
  {
  }
