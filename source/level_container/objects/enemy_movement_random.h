...
inline [[nodiscard]] auto enemy_movement_random::operator()(POINT_2F position, std::optional<POINT_2F> destination, float interval) -> std::tuple<POINT_2F, std::optional<POINT_2F>>
{
