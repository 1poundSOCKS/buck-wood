...
auto level_container::LaunchMine(POINT_2F position, POINT_2F targetPosition) -> void
{
  ...
  CreateMovingObject(level_geometries::TargetGeometry(), std::in_place_type<mine>, position, m_levelParameters.m_mineThrust, m_levelParameters.m_mineMaxSpeed, mineType, targetPosition);
}
