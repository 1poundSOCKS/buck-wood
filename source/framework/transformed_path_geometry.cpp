...
{
  HRESULT hr = framework::d2dFactory()->CreateTransformedGeometry(geometry, transform, m_geometry.put());
...
{
  HRESULT hr = framework::d2dFactory()->CreateTransformedGeometry(geometry.Get(), transform, m_geometry.put());
