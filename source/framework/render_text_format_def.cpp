...
[[nodiscard]] auto render_text_format_def::CreateTextFormat() const -> winrt::com_ptr<IDWriteTextFormat>
{
  return CreateScreenRenderTextFormat(dwrite_factory::get().get(), m_fontFamily.c_str(), m_fontWeight, m_fontStyle, m_fontStretch, m_fontSize);
}
