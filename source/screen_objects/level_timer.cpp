...
auto level_timer::SetTimeGetter(time_getter timeGetter) -> void
{
...
{
  auto currentTicks = m_timeGetter();
  auto value = static_cast<float>(currentTicks) / static_cast<float>(performance_counter::QueryFrequency());
