...
auto level_collision_handler::operator()(default_object& object1, default_object& object2) -> void
{
  ...
  OnCollision<enemy_bullet, level_cell>(object1, object2);
}
...
auto level_collision_handler::OnCollision(player_bullet& bullet, enemy_ship& enemy) -> void
{
...
auto level_collision_handler::OnCollision(player_ship& ship, enemy_ship& enemy) -> void
{
...
auto level_collision_handler::OnCollision(player_ship& playerShip, enemy_bullet& enemyBullet) -> void
{
  switch( player_state::get_status() )
  {
    case player_state::status::active:
...
auto level_collision_handler::OnCollision(enemy_bullet &bullet, level_cell &wall) -> void
{
  switch( wall.Type() )
  {
    case level_cell_type::wall:
